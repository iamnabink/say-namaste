...
class AppConfigConstants {
  // Name of app
  static String appName = 'you_app_name';
  ...
  static const googleMapApiKey = 'google_map_api_key';

  static const restApiBaseUrl = 'rest_api_ulr';

  // Socket api url
  static const socketApiBaseUrl = "socket_api_utl";
